...
function Card({ title, value, type }: { title: string; value: number | string; type: 'invoices' | 'customers' | 'pending' | 'collected'; }) {
...
export default async function CardWrapper({ data }: { data: CardWrapperData;}) {
    return (
        <>
